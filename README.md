...
1. [Обработка пропусков в данных, кодирование категориальных признаков, масштабирование данных.](https://github.com/ugapanyuk/ml_course/wiki/LAB_MISSING)
2. [Cсылка на colab](https://colab.research.google.com/gist/ZOORoman/23e908ff571dbc8a9c1775b58db822d1/lab3_ml.ipynb)
...
**Домашняя работа**
1. [Ссылка на colab](https://colab.research.google.com/drive/1elgqNAUsTWzW3rWfRaRcjzwVOvuqIuJy)
...
**Рубежный контроль №2**
1. [Ссылка на colab](https://colab.research.google.com/drive/1mwjijU0wK4iCxUi2bGHPISqRa83PrRkk)
2. [Ссылка на папку с данными](/lab2)
